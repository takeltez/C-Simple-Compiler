...
$(comp): build/compiler/SymTab.o build/compiler/CheckSymTabError.o build/compiler/Sema.o build/compiler/CheckSemanticError.o
	...
	$(G++) $(CFLAGS) build/compiler/main.o build/compiler/Lexer.o build/compiler/Token.o build/compiler/CheckStdLexemes.o build/compiler/PrintLexemes.o build/compiler/Handler.o build/compiler/ParseArray.o build/compiler/ParseFor.o build/compiler/ParseIf.o build/compiler/ParseFunc.o build/compiler/ParseOps.o build/compiler/ParseSimpleNodes.o build/compiler/ParseOtherNodes.o build/compiler/ParseWhile.o build/compiler/ParseRoot.o build/compiler/CheckError.o build/compiler/FuncAST.o build/compiler/OpsAST.o build/compiler/ArrayAST.o build/compiler/ForAST.o build/compiler/IfAST.o build/compiler/OtherNodesAST.o build/compiler/SimpleNodesAST.o build/compiler/WhileAST.o build/compiler/PrintAST.o build/compiler/RootAST.o build/compiler/SymTab.o build/compiler/CheckSymTabError.o build/compiler/Sema.o build/compiler/CheckSemanticError.o -o $(comp)
...
build/compiler/ParseFunc.o: src/parser/ParseFunc.cpp
	$(G++) $(CFLAGS) -c src/parser/ParseFunc.cpp -o build/compiler/ParseFunc.o -Isrc/lexer -Isrc/parser/AST -Isrc/symbol_table -Isrc/semantic
...
build/compiler/ParseRoot.o: src/parser/ParseRoot.cpp
	$(G++) $(CFLAGS) -c src/parser/ParseRoot.cpp -o build/compiler/ParseRoot.o -Isrc/lexer -Isrc/parser/AST -Isrc/symbol_table -Isrc/semantic
...
build/compiler/FuncAST.o: src/parser/AST/FuncAST.cpp
	$(G++) $(CFLAGS) -c src/parser/AST/FuncAST.cpp -o build/compiler/FuncAST.o -Isrc/lexer -Isrc/parser/AST -Isrc/symbol_table -Isrc/semantic -Isrc/parser
...
build/compiler/RootAST.o: src/parser/AST/RootAST.cpp
	$(G++) $(CFLAGS) -c src/parser/AST/RootAST.cpp -o build/compiler/RootAST.o -Isrc/lexer -Isrc/parser/AST -Isrc/symbol_table -Isrc/semantic -Isrc/parser
...
$(parser_test):	build/compiler/PrintAST.o build/compiler/RootAST.o build/compiler/Sema.o build/compiler/CheckSemanticError.o
	$(G++) $(CFLAGS) build/test/main.o build/test/parse_build_AST_tests.o build/test/parse_root_tests.o build/test/parse_func_tests.o build/test/parse_for_tests.o build/test/parse_while_tests.o build/test/parse_if_tests.o build/test/parse_array_tests.o build/test/parse_operations_tests.o build/test/parse_other_nodes_tests.o build/test/parse_simple_nodes_tests.o build/compiler/Lexer.o build/compiler/Token.o build/compiler/CheckStdLexemes.o build/compiler/Handler.o build/compiler/ParseArray.o build/compiler/ParseFor.o build/compiler/ParseIf.o build/compiler/ParseFunc.o build/compiler/ParseOps.o build/compiler/ParseSimpleNodes.o build/compiler/ParseOtherNodes.o build/compiler/ParseWhile.o build/compiler/ParseRoot.o build/compiler/CheckError.o build/compiler/FuncAST.o build/compiler/OpsAST.o build/compiler/ArrayAST.o build/compiler/ForAST.o build/compiler/IfAST.o build/compiler/OtherNodesAST.o build/compiler/SimpleNodesAST.o build/compiler/WhileAST.o build/compiler/PrintAST.o build/compiler/RootAST.o build/compiler/Sema.o build/compiler/CheckSemanticError.o  -lgtest -lpthread -o $(parser_test)
...
build/test/parse_func_tests.o: test/parser/parse_func_tests.cpp
	$(G++) $(CFLAGS) -c test/parser/parse_func_tests.cpp -o build/test/parse_func_tests.o -Isrc/lexer -Isrc/parser -Isrc/parser/AST -Isrc/symbol_table -Isrc/semantic
...
build/test/parse_root_tests.o: test/parser/parse_root_tests.cpp
	$(G++) $(CFLAGS) -c test/parser/parse_root_tests.cpp -o build/test/parse_root_tests.o -Isrc/lexer -Isrc/parser -Isrc/parser/AST -Isrc/symbol_table -Isrc/semantic
