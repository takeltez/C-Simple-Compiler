...
build/compiler/Handler.o: src/parser/Handler.cpp
	$(G++) $(CFLAGS) -c src/parser/Handler.cpp -o build/compiler/Handler.o -Isrc/lexer -Isrc/parser/AST
build/compiler/ParseArray.o: src/parser/ParseArray.cpp
	$(G++) $(CFLAGS) -c src/parser/ParseArray.cpp -o build/compiler/ParseArray.o -Isrc/lexer -Isrc/parser/AST
build/compiler/ParseFor.o: src/parser/ParseFor.cpp
	$(G++) $(CFLAGS) -c src/parser/ParseFor.cpp -o build/compiler/ParseFor.o -Isrc/lexer -Isrc/parser/AST
build/compiler/ParseIf.o: src/parser/ParseIf.cpp
	$(G++) $(CFLAGS) -c src/parser/ParseIf.cpp -o build/compiler/ParseIf.o -Isrc/lexer -Isrc/parser/AST
build/compiler/ParseMainFunc.o: src/parser/ParseMainFunc.cpp
	$(G++) $(CFLAGS) -c src/parser/ParseMainFunc.cpp -o build/compiler/ParseMainFunc.o -Isrc/lexer -Isrc/parser/AST
build/compiler/ParseOps.o: src/parser/ParseOps.cpp
	$(G++) $(CFLAGS) -c src/parser/ParseOps.cpp -o build/compiler/ParseOps.o -Isrc/lexer -Isrc/parser/AST
build/compiler/ParseSimpleNodes.o: src/parser/ParseSimpleNodes.cpp
	$(G++) $(CFLAGS) -c src/parser/ParseSimpleNodes.cpp -o build/compiler/ParseSimpleNodes.o -Isrc/lexer -Isrc/parser/AST
build/compiler/ParseOtherNodes.o: src/parser/ParseOtherNodes.cpp
	$(G++) $(CFLAGS) -c src/parser/ParseOtherNodes.cpp -o build/compiler/ParseOtherNodes.o -Isrc/lexer -Isrc/parser/AST
build/compiler/ParseWhile.o: src/parser/ParseWhile.cpp
	$(G++) $(CFLAGS) -c src/parser/ParseWhile.cpp -o build/compiler/ParseWhile.o -Isrc/lexer -Isrc/parser/AST
build/compiler/CheckError.o: src/parser/CheckError.cpp
	$(G++) $(CFLAGS) -c src/parser/CheckError.cpp -o build/compiler/CheckError.o -Isrc/lexer -Isrc/parser/AST

build/compiler/MainFuncAST.o: src/parser/AST/MainFuncAST.cpp
	$(G++) $(CFLAGS) -c src/parser/AST/MainFuncAST.cpp -o build/compiler/MainFuncAST.o -Isrc/lexer -Isrc/parser/AST -Isrc/parser
build/compiler/OpsAST.o: src/parser/AST/OpsAST.cpp
	$(G++) $(CFLAGS) -c src/parser/AST/OpsAST.cpp -o build/compiler/OpsAST.o -Isrc/lexer -Isrc/parser/AST -Isrc/parser
build/compiler/ArrayAST.o: src/parser/AST/ArrayAST.cpp
	$(G++) $(CFLAGS) -c src/parser/AST/ArrayAST.cpp -o build/compiler/ArrayAST.o -Isrc/lexer -Isrc/parser/AST -Isrc/parser
build/compiler/ForAST.o: src/parser/AST/ForAST.cpp
	$(G++) $(CFLAGS) -c src/parser/AST/ForAST.cpp -o build/compiler/ForAST.o -Isrc/lexer -Isrc/parser/AST -Isrc/parser
build/compiler/IfAST.o: src/parser/AST/IfAST.cpp
	$(G++) $(CFLAGS) -c src/parser/AST/IfAST.cpp -o build/compiler/IfAST.o -Isrc/lexer -Isrc/parser/AST -Isrc/parser
build/compiler/WhileAST.o: src/parser/AST/WhileAST.cpp
	$(G++) $(CFLAGS) -c src/parser/AST/WhileAST.cpp -o build/compiler/WhileAST.o -Isrc/lexer -Isrc/parser/AST -Isrc/parser
build/compiler/OtherNodesAST.o: src/parser/AST/OtherNodesAST.cpp
	$(G++) $(CFLAGS) -c src/parser/AST/OtherNodesAST.cpp -o build/compiler/OtherNodesAST.o -Isrc/lexer -Isrc/parser/AST -Isrc/parser
build/compiler/SimpleNodesAST.o: src/parser/AST/SimpleNodesAST.cpp
	$(G++) $(CFLAGS) -c src/parser/AST/SimpleNodesAST.cpp -o build/compiler/SimpleNodesAST.o -Isrc/lexer -Isrc/parser/AST -Isrc/parser
build/compiler/PrintAST.o: src/parser/AST/PrintAST.cpp
	$(G++) $(CFLAGS) -c src/parser/AST/PrintAST.cpp -o build/compiler/PrintAST.o -Isrc/lexer -Isrc/parser/AST -Isrc/parser
...
$(lexer_test): build/test/start_tests.o build/test/lexer_test.o build/compiler/Lexer.o build/compiler/Token.o build/compiler/CheckStdLexemes.o 
	$(G++) $(CFLAGS) build/test/start_tests.o build/test/lexer_test.o build/compiler/Lexer.o build/compiler/Token.o build/compiler/CheckStdLexemes.o -lgtest -lpthread -o $(lexer_test)

build/test/start_tests.o: test/start_tests.cpp
	$(G++) $(CFLAGS) -c test/start_tests.cpp -o build/test/start_tests.o -Isrc/lexer -Isrc/parser -Isrc/parser/AST
...
$(parser_test): build/test/start_tests.o build/test/parse_build_AST_tests.o build/test/parse_main_func_tests.o build/test/parse_for_tests.o 
...
$(parser_test): build/compiler/ForAST.o build/compiler/IfAST.o build/compiler/OtherNodesAST.o build/compiler/SimpleNodesAST.o build/compiler/WhileAST.o build/compiler/PrintAST.o
	$(G++) $(CFLAGS) build/test/start_tests.o build/test/parse_build_AST_tests.o build/test/parse_main_func_tests.o build/test/parse_for_tests.o build/test/parse_while_tests.o build/test/parse_if_tests.o build/test/parse_array_tests.o build/test/parse_operations_tests.o build/test/parse_other_nodes_tests.o build/test/parse_simple_nodes_tests.o build/compiler/Lexer.o build/compiler/Token.o build/compiler/CheckStdLexemes.o build/compiler/Handler.o build/compiler/ParseArray.o build/compiler/ParseFor.o build/compiler/ParseIf.o build/compiler/ParseMainFunc.o build/compiler/ParseOps.o build/compiler/ParseSimpleNodes.o build/compiler/ParseOtherNodes.o build/compiler/ParseWhile.o build/compiler/CheckError.o build/compiler/MainFuncAST.o build/compiler/OpsAST.o build/compiler/ArrayAST.o build/compiler/ForAST.o build/compiler/IfAST.o build/compiler/OtherNodesAST.o build/compiler/SimpleNodesAST.o build/compiler/WhileAST.o build/compiler/PrintAST.o  -lgtest -lpthread -o $(parser_test)

build/test/parse_build_AST_tests.o: test/parser/parse_build_AST_tests.cpp
	$(G++) $(CFLAGS) -c test/parser/parse_build_AST_tests.cpp -o build/test/parse_build_AST_tests.o -Isrc/lexer -Isrc/parser -Isrc/parser/AST
build/test/parse_main_func_tests.o: test/parser/parse_main_func_tests.cpp
	$(G++) $(CFLAGS) -c test/parser/parse_main_func_tests.cpp -o build/test/parse_main_func_tests.o -Isrc/lexer -Isrc/parser -Isrc/parser/AST
build/test/parse_for_tests.o: test/parser/parse_for_tests.cpp
	$(G++) $(CFLAGS) -c test/parser/parse_for_tests.cpp -o build/test/parse_for_tests.o -Isrc/lexer -Isrc/parser -Isrc/parser/AST
build/test/parse_while_tests.o: test/parser/parse_while_tests.cpp
	$(G++) $(CFLAGS) -c test/parser/parse_while_tests.cpp -o build/test/parse_while_tests.o -Isrc/lexer -Isrc/parser -Isrc/parser/AST
build/test/parse_if_tests.o: test/parser/parse_if_tests.cpp
	$(G++) $(CFLAGS) -c test/parser/parse_if_tests.cpp -o build/test/parse_if_tests.o -Isrc/lexer -Isrc/parser -Isrc/parser/AST
build/test/parse_array_tests.o: test/parser/parse_array_tests.cpp
	$(G++) $(CFLAGS) -c test/parser/parse_array_tests.cpp -o build/test/parse_array_tests.o -Isrc/lexer -Isrc/parser -Isrc/parser/AST
build/test/parse_operations_tests.o: test/parser/parse_operations_tests.cpp
	$(G++) $(CFLAGS) -c test/parser/parse_operations_tests.cpp -o build/test/parse_operations_tests.o -Isrc/lexer -Isrc/parser -Isrc/parser/AST
build/test/parse_other_nodes_tests.o: test/parser/parse_other_nodes_tests.cpp
	$(G++) $(CFLAGS) -c test/parser/parse_other_nodes_tests.cpp -o build/test/parse_other_nodes_tests.o -Isrc/lexer -Isrc/parser -Isrc/parser/AST
build/test/parse_simple_nodes_tests.o: test/parser/parse_simple_nodes_tests.cpp
	$(G++) $(CFLAGS) -c test/parser/parse_simple_nodes_tests.cpp -o build/test/parse_simple_nodes_tests.o -Isrc/lexer -Isrc/parser -Isrc/parser/AST
